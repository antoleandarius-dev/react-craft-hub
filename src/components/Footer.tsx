  ...
  return (
    <footer className="bg-dark-200 py-12">
      <div className="container mx-auto px-4">
          ...
          <div className="flex gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#projects" className="hover:text-accent-green transition-colors">Projects</a></li>
        ...
        <div className="border-t border-dark-300 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {currentYear} John.Dev. All rights reserved.</p>
